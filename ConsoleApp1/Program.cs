...
internal class Program
{
    static void Main(string[] args)
    {
        Tablero_LL tablerito = new Tablero_LL();
            ...
            Propiedad Casa4 = new Propiedad(5, 4, "Casa 4", 300, 50);
            Propiedad Casa5 = new Propiedad(6, 5, "Casa 5", 300, 50);
            CasillaEspecial carcel = new CasillaEspecial(7, "Carcel");
            Propiedad Casa6 = new Propiedad(8, 6, "Casa 6", 300, 50);
            CasillaEvento primerevento = new CasillaEvento(9,1);
            Propiedad Casa7 = new Propiedad(10, 7, "Casa 7", 300, 50);
            Propiedad Casa8 = new Propiedad(11, 8, "Casa 8", 400, 50);
            Propiedad Casa9 = new Propiedad(12, 9, "Casa 9", 400, 50);
            Propiedad Casa10= new Propiedad(13, 10, "Casa 10", 400, 50);
            CasillaEvento segundoevento = new CasillaEvento(14, 2);
            Propiedad Casa11 = new Propiedad(15, 11, "Casa 11", 400, 50);
            Propiedad Casa12 = new Propiedad(16, 12, "Casa 12", 500, 50);
            Propiedad Casa13 = new Propiedad(17, 13, "Casa 13", 500, 50);
            CasillaEvento tercerevento = new CasillaEvento(18, 2);
            Propiedad Casa14 = new Propiedad(19, 14, "Casa 14", 500, 50);
            Propiedad Casa15 = new Propiedad(20, 15, "Casa 15", 540, 50);
            Propiedad Casa16 = new Propiedad(21, 16, "Casa 16", 550, 50);
            CasillaEspecial libre = new CasillaEspecial(22, "Casilla Libre");
            Propiedad Casa17 = new Propiedad(23, 17, "Casa 17", 600, 50);
            Propiedad Casa18 = new Propiedad(24, 18, "Casa 18", 600, 50);
...
public class Tablero_LL
{
    ...
    public void AgregarCasilla(Casilla casilla)
    {
        ...
        public void ImprimirTablero()//esta función se puede quitar luego, solo es para ver que se agregaron las casillas correctamente
        {
            if (head == null) return;
